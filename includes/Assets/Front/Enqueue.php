...
namespace DevSupport\Assets\FrontEnd;
...
class Enqueue {
	...
	public $styles = array(
								'dev_front_core' => array('filename' => 'front-end', 'version' => '1.0.0', 'deps' => false, 'media' => 'all')
							 );
	...
	public $scripts = array(
								'dev_front_core' => array('filename' => 'front-end', 'version' => '1.0.0', 'deps' => array('jquery'), 'footer' => true)
							  );
	...
	public function register_styles($hook){
		...
		$this->styles = apply_filters('dev_front_styles', $this->styles);
	...
	public function register_scripts($hook){
		...
		$this->scripts = apply_filters('dev_front_scripts', $this->scripts);
