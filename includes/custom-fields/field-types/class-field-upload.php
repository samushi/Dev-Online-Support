 ...
 *	Custom Fields
 *
 * @package   	Custom Fields Class field - Upload
...
class CustomField_Upload extends CustomField {
	...
	public function display() {
		...
		$filetypes = explode( ',', apply_filters( 'dev_attachments_filetypes', dev_get_option( 'attachments_filetypes' ) ) );
		$accept    = array();
