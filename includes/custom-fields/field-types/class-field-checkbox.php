...
class CustomField_Checkbox extends CustomField {
	...
	public function display() {
		...
		$output        = '<legend class="dev-label-checkbox">{{label}}</legend>';
		...
		foreach ( $this->options as $option_id => $option_label ) {
			...
			$output .= sprintf( "<div class='dev-checkbox'><label><input type='checkbox' name='%s' value='%s' %s> %s</label></div>", $name_attr, $option_id, $selected, $option_label );
		}
